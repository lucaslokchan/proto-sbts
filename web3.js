...
async function printuri() {
  const uri = sbt.methods.tokenURI(0).call((err, result) => { return result });
  const a = await uri;
  console.log(a);
  //alert(a);
}
