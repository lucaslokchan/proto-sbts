      ...
      <div className={styles.main}>
        ...
        <div className="border-1">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="h-fit">
              <h1 className="title is-2">Stats</h1>
              ...
              <h2 className="subtitle is-4">Total Supply: {totalsupply}</h2>
            </div>
          </div>
        </div>
                      ...
                      return (
                        <>
                          <div className="w-[500px] h-[550px] max-w-xl overflow-hidden align-top border-2 rounded shadow-lg hover:bg-red-400">
                            ...
                            <div>
                              <div className="grid place-items-center">
                                <p className="mb-2 text-xl font-bold place-content-center">
                                  {tokeninfo.title}
                                </p>
                              </div>
                              <p>{tokeninfo.type}</p>
        ...
        <footer className="">
          <div className="">
            <p>
              <strong>© 2022 Lucas Chan</strong>{" "}
            </p>
            <p>
              <a href="https://github.com/lucaslokchan/proto-sbts">Github</a> |
